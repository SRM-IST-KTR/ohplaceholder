...
const Navbar = () => {
    ...
    return (
        <div
            ...
            className="w-full fixed top-0 left-0 flex justify-between items-center p-4 transition-colors duration-300 z-50"
        >
            {/* Logo Section */}
            ...
            {/* Desktop Menu */}
            <nav className="hidden md:flex gap-8 lg:gap-12 text-white font-extrabold z-50">
            ...
            <div
                className={`fixed top-0 right-0 h-full w-64 bg-black text-white transform ${menuOpen ? "translate-x-0" : "translate-x-full"
