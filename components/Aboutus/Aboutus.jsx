      ...
      <div className="min-h-screen bg-gradient-radial from-[#4C0058] to-[#1C0C1F] relative">
        ...
        <div className="relative z-30">
          ...
          <div className='sm:ml-10 md:ml-[100px]  xl:ml-[440px] pt-6 sm:pt-8 md:pt-10'>
            <div className='bg-[#7B008F] rounded-2xl w-[90%] sm:w-[500px] md:w-[600px] lg:w-[700px] lg:-ml-[0px]  mx-auto'>
          ...
          <div className=''>
            <Image 
              src={man} 
              alt="Man Image"
              className='absolute w-[200px] -mt-[570px] ml-[285px] hidden lg:block '
